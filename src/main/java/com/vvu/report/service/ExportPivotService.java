...
import com.vvu.report.model.SkladPivot;
    ...
    protected Task createTask() {
        return new Task<String>() {
            ...
            protected String call() throws Exception {
                ...
                String fileName = String.format("pivot%s_%s.xlsx", from.format(DateTimeFormatter.ofPattern("yyyyMMdd")), to.format(DateTimeFormatter.ofPattern("yyyyMMdd")));
